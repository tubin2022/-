...
//        int day = r.nextInt(getDay(month))+1;
    ...
    public static void write(Logistics logistics) throws IOException {
        File file = new File("C:\\Users\\Tubin\\Desktop\\logistics-data-2022-09-28.txt");
    ...
    public static void main(String[] args) throws InterruptedException, ParseException, IOException {
        Integer logisticsNum = 1;
        while (logisticsNum <= 30000){
            //寄件
...
//                System.out.println(logistics);
    ...
    public static void run() throws ParseException, IOException, InterruptedException {
        Integer logisticsNum = 1;
        while (logisticsNum <= 30000){
            //寄件
            Logistics logistics = new Logistics();
